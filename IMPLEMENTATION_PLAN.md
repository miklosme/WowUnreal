...
- [x] Add first-party automated tests for parsers, world streaming, networking, UI, and addon loading — verified March 14, 2026: WowTests module with 13 UE5 automation tests (3 coord, 3 entity, 1 MPQ, 6 parser); graceful MPQ skip; builds
