...
- [ ] Complete the typed entity hierarchy required by `specs/networking.md` — `FWowEntity` is still a single generic struct with raw field maps; typed player/unit/item/gameobject views or subclasses are still missing.
